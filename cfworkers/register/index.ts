...
async function handleGet(request) {
  ...
  const keyjson = await keypromise.json();
  const response = jwtVerify(token, keyjson["keys"][0]["x5c"], {
    issuer: 'dev-qy-iakti.us.auth0.com',
    audience: 'eEBy63jCkRcKBsKpAfOWit5hg8JgZzpG'
  })
